...
public class ColumnInfoBuilder {
    ...
    public ColumnInfo build() {
        return new ColumnInfo(columnName, attributeName, attributeType, isEmbedded, isEnum, isCompositePk, isPkColumn, isFkColumn, isCollection, inverseFkColumn, compositeColumns, isInverseComposite);
    }
}
